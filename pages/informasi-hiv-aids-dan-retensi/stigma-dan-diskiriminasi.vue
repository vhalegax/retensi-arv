  ...
  <v-row>
    <v-col>
      <p>
        ...
        pengucilan, penolakan, menyalahkan atau devaluasi yang merugikan
        seseorang atau kelompok. Rasa malu atau aib yang melekat diekspresikan
        melalui reaksi negatife social terhadap penderita keluarga dan
        orang-orang terdekatnya. Sedang Stigma terkait HIV/AIDS adalah segala
        prasangka buruk yang berasal dari pikiran sendiri ataupun orang lain
        dengan bentuk diskriminasi maupun penghinaan yang ditujukan pada ODHA,
        keompok komunitas atau keluarganya. Penerimaan stigma :Keyakinan orang
        lain yang memiliki pemikiran negative terhadap mereka yang dirasakan
        sepenuhnya, baik secara subyektif, isolasi memandang ODHA dengan penuh
        stigmatisasi dan ditolak, dikucilkan, dijauhi
      </p>
